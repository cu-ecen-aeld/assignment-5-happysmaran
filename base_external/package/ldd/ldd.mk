# Remove the single quotes from the version if you haven't already
...
define LDD_BUILD_CMDS
	# Call the Makefile INSIDE the scull/misc folders
	# This ensures the .h files are generated before 'make modules' runs
...
define LDD_INSTALL_TARGET_CMDS
	...
	# Use INSTALL -D to create paths if they don't exist
